...
![Agent không có skill: 12 lần tìm kiếm thất bại](images/before-12-searches.png?v=2)
...
![Agent với skill: tìm đúng ngay lập tức và trace root cause](images/after-trace-success.png?v=2)

Chi tiết quá trình trace từ error → root cause:

![Quá trình Data Flow Tracing chi tiết](images/comparison-table.png?v=2)
...
![Ước tính tiết kiệm token với Update Helper v4](images/token-savings.png?v=2)
