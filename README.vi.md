...
![Agent không có skill: 12 lần tìm kiếm thất bại](images/s2-before.png)
...
![Agent với skill: tìm đúng ngay lập tức và trace root cause](images/s1-after.png)

Chi tiết quá trình trace từ error → root cause:

![Quá trình Data Flow Tracing chi tiết](images/s3-trace.png)
